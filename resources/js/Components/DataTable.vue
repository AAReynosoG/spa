        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tr v-for="(obj, key) in arr" :key="key" scope="row">
                <td class="px-6 py-4 whitespace-nowrap">
                    <Link :href="route('students.show', {id: obj.id})" class="text-indigo-600 hover:text-indigo-900">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <Link class="text-indigo-600 hover:text-indigo-900" :href="route('students.edit', {id: obj.id})">
                        Update
                    </Link>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <Link class="text-red-600 hover:text-red-900" :href="route('students.confirmDelete', {id: obj.id})">
                        Delete
                    </Link>
                </td>
            </tr>
